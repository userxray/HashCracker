...
def info():
        ...
        print (GG+" |"+YY+" ["+CC+"="+YY+"] "+WW+"Author   "+CC+":"+WW+" TurkishDARK Hacker"+GG+"                          |")
        print (GG+" |"+YY+" ["+CC+"="+YY+"] "+WW+"Email    "+CC+":"+WW+" turkishdarkhacker@gmail.com"+GG+"                |")
        print (GG+" |"+YY+" ["+CC+"="+YY+"] "+WW+"Github   "+CC+":"+WW+" https://github.com/userxray"+GG+"       |")
        print (GG+" 0{===================================================}0\n")
